...
if(isset($_REQUEST['m']))
{
	switch($_REQUEST['m'])
	{
		case 'p':
			...
			$url="https://api.objectrocket.com/db/havenly/collection/students/post";
			$document = "";
		break;
		case 'g':
			// Define the url for the HTTP POST.
			$url="https://api.objectrocket.com/db/havenly/collection/students/get";
			// Define document query to get all items.
			$document = json_encode(array("firstName" => array('$ne' => '')));
		break;
		default:
		break;
	}	
